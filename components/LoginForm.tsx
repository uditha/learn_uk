  ...
  return (
    <div className="gate">
      <div className="gate-box">
        ...
        <p className="lede">
          FRE1 and FRE2 in 90-second cards, checked against the 2025/26 texts. Enter the password
          on your phone, laptop, or tablet to pick up where you left off.
        </p>
